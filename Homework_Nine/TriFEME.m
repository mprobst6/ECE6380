...
%  write results to file 'potfil.txt'
   ...
   str = ['Eigenvalue = ',num2str(real(sqrt(E(1))))];  disp(str);
   fprintf(fid,'%s\n\n',str);
   str = ['Eigenvalue = ',num2str(real(sqrt(E(2))))];  disp(str);
   fprintf(fid,'%s\n\n',str);
   str = ['Eigenvalue = ',num2str(real(sqrt(E(3))))];  disp(str);
   fprintf(fid,'%s\n\n',str);
   str = ['Eigenvalue = ',num2str(real(sqrt(E(4))))];  disp(str);
   fprintf(fid,'%s\n\n',str);
   str = ['Eigenvalue = ',num2str(real(sqrt(E(5))))];  disp(str);
   fprintf(fid,'%s\n\n',str);
